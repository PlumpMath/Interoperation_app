    ...
    implements MessageEventHandler
{
     ...
     * @throws org.ice4j.StunException if anything goes wrong while sending the specified
     ...
     *
     * @throws java.io.IOException  if an error occurs while sending message bytes
     ...
     * @throws IllegalArgumentException if the apDescriptor references an
     * access point that had not been installed,
     * @throws org.ice4j.StunException if message encoding fails
     */
     ...
     *
     * @param evt the {@link org.ice4j.StunMessageEvent} that contains the {@link
     * org.ice4j.message.Request} that we need to validate.
     *
     ...
     * invalid checksum
     * or username)
     * @throws org.ice4j.StunException if we fail while sending an error response.
     * @throws java.io.IOException if we fail while sending an error response.
     */
