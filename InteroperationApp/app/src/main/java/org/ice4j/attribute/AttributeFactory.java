...
public class AttributeFactory
{
     ...
     * @throws org.ice4j.StunException if the error class or number have invalid values
     ...
     * @return the newly created attribute.
     * @throws org.ice4j.StunException if errorCode is not a valid error code as defined
     * by rfc3489
     */
     ...
     * key (password) that the {@link org.ice4j.attribute.Attribute#encode()} method should use when
