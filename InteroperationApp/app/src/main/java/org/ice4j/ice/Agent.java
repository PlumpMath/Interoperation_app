...
public class Agent
{
     ...
     * (using {@link #addStateChangeListener(java.beans.PropertyChangeListener)}.
     */
    ...
    /**
     * The name of the {@link java.beans.PropertyChangeEvent} that we use to deliver
...
//    private final HarvestStatistics harvestStats = new HarvestStatistics();
     ...
     * org.ice4j.ice.Agent} and following its changes of state.
     */
     ...
     * @throws java.io.IOException if an error occurs while the underlying resolver lib
     * is using sockets.
     * @throws java.net.BindException if we couldn't find a free port between
    ...
    /**
     * Indicates whether this {@link org.ice4j.ice.Agent} is currently in the process of
     * running connectivity checks and establishing connectivity. Connectivity
     * establishment is considered to have started after both {@link org.ice4j.ice.Agent}s
     ...
     * <p>
     * Note that an {@link org.ice4j.ice.Agent} would be ready to and will send responses to
    ...
    /**
     * Indicates whether this {@link org.ice4j.ice.Agent} has finished ICE processing.
     *
...
//    }
     ...
     * <tt>localAddress</tt> if it belongs to any of this {@link org.ice4j.ice.Agent}'s
     ...
     * <tt>remoteAddress</tt> if it belongs to any of this {@link org.ice4j.ice.Agent}'s
     * streams or <tt>null</tt> if it doesn't.
     *
     ...
     * {@link org.ice4j.ice.Agent}'s streams contain such a pair.
     *
     ...
     *
     * @see org.ice4j.ice.Agent#setNominationStrategy(NominationStrategy)
     */
    ...
    /**
     * Returns the number of host {@link Candidate}s in this {@link org.ice4j.ice.Agent}.
     *
     * @return the number of host {@link Candidate}s in this {@link org.ice4j.ice.Agent}.
     */
    ...
    /**
     * Initializes and starts the {@link org.ice4j.ice.Agent.TerminationThread}
     */
