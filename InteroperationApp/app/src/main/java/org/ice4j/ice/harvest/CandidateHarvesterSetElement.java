...
class CandidateHarvesterSetElement
{
     ...
     * {@link org.ice4j.ice.harvest.CandidateHarvester#harvest(org.ice4j.ice.Component)} is to be
    ...
    /**
     * Calls {@link org.ice4j.ice.harvest.CandidateHarvester#harvest(org.ice4j.ice.Component)} on the
     * associated <tt>CandidateHarvester</tt> if <tt>enabled</tt>.
     *
     * @param component the <tt>Component</tt> to gather candidates for
     * @param trickleCallback the {@link org.ice4j.ice.harvest.TrickleCallback} that we will be
     ...
     * {@link org.ice4j.ice.harvest.CandidateHarvester#harvest(Component)} is to be called on the
