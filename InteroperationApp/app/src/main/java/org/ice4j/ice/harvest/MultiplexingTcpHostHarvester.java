    ...
    extends CandidateHarvester
{
    ...
    /**
     * Determines whether a specific {@link java.net.DatagramPacket} is the first
     * expected (i.e. supported) to be received from an accepted
     * {@link java.nio.channels.SocketChannel} by this {@code MultiplexingTcpHostHarvester}. If
        ...
        extends Thread
    {
         ...
         *
         * @throws java.io.IOException if the selector to be used fails to open.
         */
        public ReadThread()
            throws IOException
        {
