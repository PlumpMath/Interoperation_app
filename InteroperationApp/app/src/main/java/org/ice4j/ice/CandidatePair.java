    ...
    implements Comparable<CandidatePair>
{
    ...
    /**
     * The {@link org.ice4j.stack.TransactionID} of the client transaction for a connectivity
     ...
     * the ICE agent, during the execution of the ICE procedures.
     *
     * @param tranID the {@link org.ice4j.stack.TransactionID} that we are using for the
    ...
    /**
     * Returns the {@link org.ice4j.stack.TransactionID} used in the connectivity check
     * associated with this {@link org.ice4j.ice.CandidatePair} when it's in the
     * {@link CandidatePairState#IN_PROGRESS} or <tt>null</tt> if it's in
     * any other state.
     *
     * @return the {@link org.ice4j.stack.TransactionID} used in the connectivity check
     * associated with this {@link org.ice4j.ice.CandidatePair} when it's in the
     * {@link CandidatePairState#IN_PROGRESS} or <tt>null</tt> if it's in
     * any other state.
     */
