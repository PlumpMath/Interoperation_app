...
public class IceSdpUtils
{
     ...
     *
     * @param sDes the {@link javax.sdp.SessionDescription} that we'd like to setup as per
     * the specified agent.
     * @param agent the {@link org.ice4j.ice.Agent} that we need to use when initializing
     ...
     *
     * @param localCandidates the list of {@link org.ice4j.ice.LocalCandidate}s that we'd like
