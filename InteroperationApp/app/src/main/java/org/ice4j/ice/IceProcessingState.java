 ...
 * state that reflects the state of an {@link org.ice4j.ice.Agent} before it starts
 * processing. This is also an {@link org.ice4j.ice.Agent }'s default state. The second one
...
public enum IceProcessingState
{
     ...
     * for the corresponding {@link org.ice4j.ice.Agent}.
     */
    WAITING("Waiting"),
