    ...
    implements ResponseCollector
{
    ...
    /**
     * The {@link org.ice4j.ice.ConnectivityCheckClient.PaceMaker}s that are currently running checks in this client.
     */
    ...
    /**
     * Starts client connectivity checks for the first {@link org.ice4j.ice.IceMediaStream}
     * in our parent {@link org.ice4j.ice.Agent}. This method should only be called by
     * the parent {@link org.ice4j.ice.Agent} when connectivity establishment starts for a
    ...
    /**
     * Starts client connectivity checks for the {@link org.ice4j.ice.CandidatePair}s in
     *  <tt>checkList</tt>
     *
     * @param checkList the {@link org.ice4j.ice.CheckList} to start client side connectivity
     * checks for.
     */
     ...
     * as a keep-alive.
     *
     * @param candidatePair that {@link org.ice4j.ice.CandidatePair} that we'd like to send
     * an indication
     */
    ...
    /**
     * Creates a STUN {@link org.ice4j.message.Request} containing the necessary PRIORITY and
     ...
     *
     * @param candidatePair that {@link org.ice4j.ice.CandidatePair} that we'd like to start
     * a check for.
     *
    ...
    /**
     * Returns <tt>true</tt> if the {@link org.ice4j.message.Response} in <tt>evt</tt> had a
     * source or a destination address that match those of the {@link org.ice4j.message.Request},
     ...
     * org.ice4j.message.Response} we need to examine
     *
     * @return <tt>true</tt> if the {@link org.ice4j.message.Response} in <tt>evt</tt> had a
     * source or a destination address that matched those of the
     * {@link org.ice4j.message.Request}, or <tt>false</tt> otherwise.
     */
    ...
    /**
     * Sets the state of the corresponding {@link org.ice4j.ice.CandidatePair} to
     * {@link org.ice4j.ice.CandidatePairState#FAILED} and updates check list and timer
     * states.
     *
     * @param ev the {@link StunTimeoutEvent} containing the original
     * transaction and hence {@link org.ice4j.ice.CandidatePair} that's being checked.
     */
        ...
        extends Thread
    {
        ...
        /**
         * The {@link org.ice4j.ice.CheckList} that this <tt>PaceMaker</tt> will be running
         * checks for.
         */
        private final CheckList checkList;

        /**
         * Creates a new {@link org.ice4j.ice.ConnectivityCheckClient.PaceMaker} for this
         * <tt>ConnectivityCheckClient</tt>.
         *
         * @param checkList the {@link org.ice4j.ice.CheckList} that we'll be sending checks
         * for
         */
         ...
         * org.ice4j.ice.Agent#calculateTa()} method and using either the trigger check queue
