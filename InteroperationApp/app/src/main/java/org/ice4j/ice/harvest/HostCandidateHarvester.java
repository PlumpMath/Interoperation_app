...
public class HostCandidateHarvester
{
     ...
     *
     * @param iface The {@link java.net.NetworkInterface}.
     *
     * @return <tt>true</tt> if the {@link java.net.NetworkInterface} is listed in the
     ...
     * harvester went.
     *
     * @return The {@link org.ice4j.ice.harvest.HarvestStatistics} describing this harvester's
     * harvests.
     */
     ...
     *
     * @throws IllegalStateException if there were errors during host
