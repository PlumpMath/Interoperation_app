...
/**
 * Implements {@link java.util.Set} of <tt>CandidateHarvester</tt>s which runs the
    ...
    extends AbstractSet<CandidateHarvester>
{
     ...
     * @see org.ice4j.ice.harvest.CandidateHarvester#harvest(org.ice4j.ice.Component)
     */
    ...
    public Iterator<CandidateHarvester> iterator()
    {
        ...
        return
            new Iterator<CandidateHarvester>()
            {
                 ...
                 * @throws java.util.NoSuchElementException if this iteration has no more
                 * elements
