 ...
 * {@link org.ice4j.TransportAddress}es. This harvester is meant for use in situations
 * where servers are deployed behind a NAT or in a DMZ with static port mapping.
 * <p>
 * Every time the {@link #harvest(org.ice4j.ice.Component)} method is called, the mapping
    ...
    extends CandidateHarvester
{
     ...
     * <tt>component</tt>.
     *
     * @param component the {@link org.ice4j.ice.Component} that we'd like to map candidates
     * to.
