...
public class IceMediaStream
{
    ...
    /**
     * Contains {@link java.beans.PropertyChangeListener}s registered with this {@link
     * org.ice4j.ice.Agent} and following the various events it may be generating.
     */
     ...
     * org.ice4j.ice.Component}s or <tt>null</tt> if it doesn't.
     *
    ...
    /**
     * Returns the {@link org.ice4j.ice.CandidatePair} with the specified remote and local
     * addresses or <tt>null</tt> if neither of the {@link org.ice4j.ice.CheckList}s in this
     ...
     * are looking for.
     *
     * @return the {@link org.ice4j.ice.CandidatePair} with the specified remote and local
     * addresses or <tt>null</tt> if neither of the {@link org.ice4j.ice.CheckList}s in this
     * stream contain such a pair.
     */
    ...
    /**
     * Returns the number of host {@link org.ice4j.ice.Candidate}s in this stream.
     *
     * @return the number of host {@link org.ice4j.ice.Candidate}s in this stream.
     */
     ...
     * maintaining.
     *
     * @param pair the {@link org.ice4j.ice.CandidatePair} to add to our valid list.
     */
     ...
     * one {@link org.ice4j.ice.CandidatePair} for each {@link org.ice4j.ice.Component} of the stream and
     * <tt>false</tt> otherwise.
     *
     ...
     * org.ice4j.ice.CandidatePair} in the valid list for every {@link org.ice4j.ice.Component} of this
     ...
     * org.ice4j.ice.CandidatePair} who doesn't have a selected address yet, and <tt>true</tt>
     * otherwise.
     *
    ...
    /**
     * Returns the first {@link org.ice4j.ice.CandidatePair} stored in this stream's valid
     * list, that belongs to the specified <tt>component</tt>.
     *
     * @param component the {@link org.ice4j.ice.Component} we'd like to obtain a valid
     * pair for.
     *
     * @return a valid {@link org.ice4j.ice.CandidatePair} for the specified
     ...
     * if {@link org.ice4j.ice.CandidatePair}s. We add such listeners in the stream, rather
    ...
    /**
     * Creates a new {@link java.beans.PropertyChangeEvent} and delivers it to all
     * currently registered state listeners.
     *
     * @param source the {@link org.ice4j.ice.CandidatePair} whose property has just changed.
