...
public class NetworkConfigurationDiscoveryProcess
{
     ...
     * @throws java.io.IOException if we fail to bind.
     * @throws org.ice4j.StunException if the stun4j stack fails start for some reason.
     */
    public void start()
     ...
     *
     * @throws org.ice4j.StunException ILLEGAL_STATE if the discoverer has not been started
     * @throws java.io.IOException if a failure occurs while executing the discovery
     * algorithm.
     */
     ...
     * was received.
     *
     * @throws org.ice4j.StunException if an exception occurs while sending the messge
     * @throws java.io.IOException if an error occurs while sending bytes through
     * the socket.
     */
...
*/
     ...
     *
     * @throws org.ice4j.StunException if an exception occurs while sending the messge
     * @throws java.io.IOException if an exception occurs while executing the algorithm.
     */
     ...
     * was received.
     * @throws org.ice4j.StunException if an exception occurs while sending the messge
     * @throws java.io.IOException if an exception occurs while sending bytes through
     * the socket.
     */
     ...
     * @throws org.ice4j.StunException ILLEGAL_STATE if the discoverer is not operational.
     */
     ...
     * @throws Exception if an exception occurrs during the discovery
     * process.
     */
/*
