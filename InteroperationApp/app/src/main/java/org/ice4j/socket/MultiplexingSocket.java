    ...
    extends DelegatingSocket
{
     ...
     * reading from the network  using {@link #receive(java.net.DatagramPacket)}. When
     ...
     * Initializes a new <tt>MultiplexingSocket</tt> instance.
     *
     * @see java.net.Socket#Socket(java.net.Proxy)
     */
     ...
     * Initializes a new <tt>MultiplexingSocket</tt> instance.
     *
     * @see java.net.Socket#Socket(java.net.SocketImpl)
     */
     ...
     * @see org.ice4j.socket.DelegatingSocket#receive(java.net.DatagramPacket)
     */
    @Override
     ...
     * timeout
     * @throws java.net.SocketTimeoutException if the timeout has expired
     * @throws java.io.IOException if an I/O error occurs
     */
