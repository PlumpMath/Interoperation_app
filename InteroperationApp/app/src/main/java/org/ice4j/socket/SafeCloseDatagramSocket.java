 ...
 * {@link java.net.DatagramSocket#close()} is called while another thread is blocked in
 * its {@link java.net.DatagramSocket#receive(java.net.DatagramPacket)}, calling
 * {@link java.net.DatagramSocket#bind(java.net.SocketAddress)} throws an "Already bound"
    ...
    extends DelegatingDatagramSocket
{
    ...
    /**
     * The number of {@link #receive(java.net.DatagramPacket)} calls that have to return
     ...
     * throw a {@link java.net.SocketException} and this datagram socket will wait for it
     * to return.
     * </p>
     *
