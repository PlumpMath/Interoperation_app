    ...
    extends DatagramSocket
{
     ...
     *
     * @see java.net.DatagramSocket#setReceiveBufferSize(int) for a discussion of the
     ...
     *
     * @throws java.net.SocketException if the socket could not be opened, or the socket
     * could not bind to the specified local port
     * @see java.net.DatagramSocket#DatagramSocket()
     */
     ...
     * to delegate
     * @throws java.net.SocketException if anything goes wrong while initializing the new
     ...
     * <p>
     * Any thread currently blocked in {@link #receive(java.net.DatagramPacket)} upon
     * this socket will throw a {@link java.net.SocketException}.
     * </p>
     *
     ...
     * call to {@link #send(java.net.DatagramPacket)} or {@link #receive(java.net.DatagramPacket)}
     ...
     * @throws java.net.SocketException if the connect fails
    ...
    /**
     * Returns the unique {@link java.nio.channels.DatagramChannel} object associated with this
     * datagram socket, if any.
     * <p>
     * A datagram socket will have a channel if, and only if, the channel itself
     * was created via the {@link java.nio.channels.DatagramChannel#open()} method
     * </p>
     *
     ...
     * @throws java.net.SocketException if there is an error obtaining the traffic class
     ...
     * option
     * @throws java.net.SocketException if an error occurs enabling or disabling the
     ...
     * {@link #receive(java.net.DatagramPacket)} for this <tt>DatagramSocket</tt> will
     ...
     * @throws java.net.SocketException if there is an error setting the traffic class or
     * type-of-service
