...
/**
 * If supported by the runtime, initializes {@link java.nio.channels.ServerSocketChannel}s which
...
public class MuxServerSocketChannelFactory
{
     ...
     * of the {@code ServerSocketChannel} returned by {@link #openAndBind(java.util.Map,
     * java.net.SocketAddress, int, org.ice4j.socket.DatagramPacketFilter)} which specifies the value of
    ...
    /**
     * Closes a {@code Channel} and swallows any {@link java.io.IOException}.
     *
     ...
     * back to {@link #openAndBindServerSocketChannel(java.util.Map, java.net.SocketAddress, int)}.
     *
     * @param properties a {@code Map} of the values to be assigned to
     * properties of the underlying {@link java.nio.channels.ServerSocketChannel} which is to
