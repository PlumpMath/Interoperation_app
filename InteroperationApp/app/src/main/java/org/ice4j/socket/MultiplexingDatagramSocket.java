    ...
    extends SafeCloseDatagramSocket
{
     ...
     * {@link java.net.DatagramSocket#receive(java.net.DatagramPacket)}. When <tt>true</tt>,
    ...
    /**
     * The value with which {@link java.net.DatagramSocket#setReceiveBufferSize(int)} is
     ...
     * {@link java.net.DatagramSocket#setReceiveBufferSize(int)} is to be invoked with
     ...
     * @throws java.net.SocketException if the socket could not be opened, or the socket
     * could not bind to the specified local port
     * @see java.net.DatagramSocket#DatagramSocket(java.net.SocketAddress)
     */
     ...
     * @throws java.net.SocketException if creating the
     ...
     * @throws java.net.SocketTimeoutException if <tt>setSoTimeout(int)</tt> was
     ...
     * timeout
     * @throws java.io.IOException if an I/O error occurs
     * @throws java.net.SocketTimeoutException if <tt>timeout</tt> is positive and has
     * expired
     */
