    ...
    implements MessageEventHandler
{
     ...
     * data it has been asked to {@link #send(java.net.DatagramPacket)} and
     * {@link #receive(java.net.DatagramPacket)}. Since data can be exchanged with a TURN
     ...
     * {@link #receive(java.net.DatagramPacket)} method. They have been received from the
     ...
     * <tt>DatagramSocket</tt> using its {@link #send(java.net.DatagramPacket)} method
     ...
     * in {@link #packetsToReceive}.
     *
     * @throws java.net.SocketException if anything goes wrong while receiving
    ...
    private class Channel
    {
         ...
         * {@link org.ice4j.socket.RelayedCandidateDatagramSocket#channelDataSocket}.
         */
         ...
         *
         * @throws org.ice4j.StunException if anything goes wrong while binding/installing
         * this channel
         */
        public void bind()
         ...
         * @throws org.ice4j.StunException if anything goes wrong while sending the
