    ...
    implements PseudoTcpNotify
{
    ...
    private static final Logger logger =
        Logger.getLogger(PseudoTcpSocketImpl.class.getName());
    /**
     ...
     * @param port the port number.
     * @throws java.io.IOException if an I/O error occurs when attempting a connection.
     */
     ...
     * @throws java.io.IOException if an I/O error occurs when creating the queue.
     */
     ...
     * @param timeout for this operation in ms
     * @throws java.io.IOException If socket gets closed or timeout expires
     */
     ...
     * @throws java.io.IOException if an I/O error occurs when accepting the connection.
     */
     ...
     *
     * @param tcp the {@link org.ice4j.pseudotcp.PseudoTCPBase} that caused an event
     * @see org.ice4j.pseudotcp.PseudoTcpNotify#onTcpOpen(org.ice4j.pseudotcp.PseudoTCPBase)
     */
     ...
     *
     * @param tcp the {@link org.ice4j.pseudotcp.PseudoTCPBase} that caused an event
     * @see org.ice4j.pseudotcp.PseudoTcpNotify#onTcpReadable(org.ice4j.pseudotcp.PseudoTCPBase)
     */
     ...
     *
     * @param tcp the {@link org.ice4j.pseudotcp.PseudoTCPBase} that caused an event
     * @see org.ice4j.pseudotcp.PseudoTcpNotify#onTcpWriteable(org.ice4j.pseudotcp.PseudoTCPBase)
     */
     ...
     * 
     * @see org.ice4j.pseudotcp.PseudoTcpNotify#onTcpClosed(org.ice4j.pseudotcp.PseudoTCPBase, java.io.IOException)
     */
     ...
     * 
     * @see org.ice4j.pseudotcp.PseudoTcpNotify#tcpWritePacket(org.ice4j.pseudotcp.PseudoTCPBase, byte[], int)
     */
     ...
     * @throws java.io.IOException if an I/O error occurs when creating the output stream.
     */
     ...
     * @throws java.io.IOException if an I/O error occurs when determining the number of bytes available.
     */
    ...
    class PseudoTcpInputStream extends InputStream
    {
         ...
         * @throws java.io.IOException in case of en error
         */
        @Override
         ...
         * @throws java.io.IOException in case of error or if timeout occurs
         */
        @Override
