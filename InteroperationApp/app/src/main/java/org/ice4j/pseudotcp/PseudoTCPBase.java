 ...
 *
 * @see org.ice4j.pseudotcp.PseudoTCPBase#connect
 * @see org.ice4j.pseudotcp.PseudoTCPBase#recv
 * @see org.ice4j.pseudotcp.PseudoTCPBase#send
 * @see PseudoTcpNotify
 * @author Pawel Domas
 */
public class PseudoTCPBase
{
     ...
     *
     * @throws java.io.IOException if the protocol is not in initial state
     */
     ...
     *
     * @param now current timestamp
     * @see org.ice4j.pseudotcp.PseudoTCPBase#getNextClock(long)
     */
    ...
    /**
     * Retrieve option's value. See {@link org.ice4j.pseudotcp.Option} for available options
     *
    ...
    /**
     * Sets {@link org.ice4j.pseudotcp.Option} value
     *
     ...
     * @throws java.io.IOException if the protocol is not in the connected state
     */
     ...
     * @throws java.io.IOException if the protocol is not in connected state
     */
...
//
     ...
     *
     * @see PseudoTcpNotify
     * @see org.ice4j.pseudotcp.WriteResult
     */
