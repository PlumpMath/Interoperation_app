...
import ntu.selab.iot.interoperationapp.serviceHandler.format.Format;
import ntu.selab.iot.interoperationapp.serviceHandler.format.audio.AudioFormat;
import ntu.selab.iot.interoperationapp.serviceHandler.format.video.H263VideoFormat;
import ntu.selab.iot.interoperationapp.serviceHandler.format.video.H264VideoFormat;
import ntu.selab.iot.interoperationapp.serviceHandler.format.video.VideoFormat;
import ntu.selab.iot.interoperationapp.serviceHandler.media.codex.video.Codec;
...
public class MediaRegistry {
    ...
    public static Codec[] generateEncodingCodecChain(String encoding) {
        if (encoding.equalsIgnoreCase(H264VideoFormat.ENCODING)) { 
                ...
                Codec[] chain = {
                    new ntu.selab.iot.interoperationapp.serviceHandler.media.codex.video.h264.JavaPacketizer()
                };
                return chain;
        } else
        if (encoding.equalsIgnoreCase(H263VideoFormat.ENCODING)) {
                ...
                Codec[] chain = {
                        new ntu.selab.iot.interoperationapp.serviceHandler.media.codex.video.h263.JavaPacketizer()
                };
                return chain;
                } else { 
        ...
        public static Codec[] generateDecodingCodecChain(String encoding) {
                if (encoding.equalsIgnoreCase(H264VideoFormat.ENCODING)) {
	                ...
	                Codec[] chain = {
	                    new ntu.selab.iot.interoperationapp.serviceHandler.media.codex.video.h264.JavaDepacketizer()
	                };
	                return chain;
                } else if (encoding.equalsIgnoreCase(H263VideoFormat.ENCODING)) {
	                // Java H263 depacketizer
	                Codec[] chain = {
	                        new ntu.selab.iot.interoperationapp.serviceHandler.media.codex.video.h263.JavaDepacketizer()
	                };
	                return chain;        
                } else {
                        // Codec implemented in the native part
